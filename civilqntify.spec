...
hiddenimports = _hidden_collected + [
    ...
    "app.widgets.is_trial_mixes_dialog",
    ...
    "concrete_mix.engine.psd_link",
    "concrete_mix.engine.target_strength",
    ...
    "material_quantify",
    "material_quantify.cost",
    "material_quantify.engine",
    "material_quantify.engine.quantifier",
    "material_quantify.engine.ratio_quantifier",
